...
const config = Object.assign(require('./constants/config'), dotenv);
...
module.exports = function (env) {
  ...
  const envars = {
    ...
    API_GOV: JSON.stringify(config.API_GOV),
    API_GOV_KEY: JSON.stringify(config.API_GOV_KEY),
  };
  ...
  return {
    ...
    entry: {
      ...
      app: [
        ...
        'assets/styles/react-datetime.css',
        'react-select/dist/react-select.css',
        'assets/styles/style-private.css',
        'assets/styles/page/_page.scss',
        'assets/styles/layout.scss',
        'assets/styles/font-icon/fontawesome-all.min.css',
    ...
    resolve: {
      ...
      alias: {
        ...
        'react-dates-range': path.resolve(__dirname, './node_modules/react-dates')
      },
      modules: [
